...
module.exports = function googleParse(messageObject) {
  ...
  if (messageObject && messageObject.user && messageObject.inputs && messageObject.inputs.rawInputs) {
    return {
      sender: messageObject.user.userId,
      text: messageObject.inputs.rawInputs.query,
      originalRequest: messageObject,
      type: 'google'
    };
  }

  if (messageObject && messageObject.user) {
    return {
      sender: messageObject.user.userId,
      text: '',
      originalRequest: messageObject,
